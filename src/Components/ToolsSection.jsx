  ...
  return (
    <>
      ...
      <div className="my-10 flex items-center justify-center flex-col mx-10">
        ...
        <div className="flex justify-center gap-y-4 flex-wrap space-x-20  py-10 px-4 md:px-20 w-full rounded-lg">
          {projectStarterPack.map((tool, index) => (
            <div
              key={index}
              className="bg-white relative boxgrad z-[30] p-6 rounded-lg text-center w-40"
            >
              <img
                src={tool.image}
                alt={tool.text}
      ...
      <div className="blur-3xl">
        <div
                className="absolute blur-3xl left-[calc(20%+3rem)] aspect-[1155/678] z-50 w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#933131] from-50% to-[#ef8717] to-40% via-[#b9c510] opacity-30 sm:left-[calc(30%+7rem)] sm:top-[-120rem] sm:w-[80.1875rem] sm:h-[60rem]"
                style={{
                clipPath:
