...
import hireSpeed from '../Images/hireSpeed.svg'
  ...
  return (
    ...
    <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">                
          ...
          <div class="p-5 gap-y-4 flex flex-col justify-center items-center font-semibold h-48 overflow-hidden rounded-lg border md:h-80 bg-[#fafaf9]">

            <img src={hireSpeed} alt="hireSpeed" />

            <div className='font-outfit text-4xl'>
              <span className="main-gradient">Blazing</span> fast websites. 
            </div>
