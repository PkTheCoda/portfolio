        ...
        <div className="relative px-5 lg:px-10 xl:px-20 flex justify-center mb-20">
          ...
          <div className="bg-[#171717] text-white text-center w-full text-5xl font-semibold rounded-xl py-20 flex flex-col gap-y-4 items-center font-outfit px-5 xl:px-20 relative ">
            ...
            <div className="text-5xl block z-30 text-[#f53c80]">
              You don't pay a dime <span className="text-[#1bc1f7] ">until</span> the website is done.
            </div>
            <div className="text-xl font-light w-full px-0 xl:px-20 block z-30">
              Yep, it's that simple: no payment until you see the site. The benefit? No worrying about paying for something you dislike. 
              But obviously, if you don't pay, you don't get the site. This won't be an issue though because once you see the site,    
              the last thing on your mind is not paying for it 😉. But why do this? From my experience, people are pretty skeptical 
              when a 16 year old offers to make their site so this feature will keep you from worrying about paying for something you don't like!
              <br />
              <br />


            </div>
            <a href="https://tally.so/r/wLpGWy" target="_blank" className="bg-[#f53c80] z-40 px-3 transition transform duration-300 hover:scale-105 py-2 rounded-xl text-xl font-normal">
              Let's Do This!
            </a>
          </div>
        </div>
